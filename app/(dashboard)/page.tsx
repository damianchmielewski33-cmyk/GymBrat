  ...
  return (
    <div className="space-y-8">
      ...
      <section className="space-y-6">
        ...
        />
        <MealLogsList entries={mealEntries} dateKey={dash.todayKey} />
        <NutritionProgressBars
          ...
          weekDetail={
            weekG > 0
              ...
              : "Brak sumy celów tygodnia — ustaw makra w profilu dla treningu i odpoczynku."
          }
        ...
        <section className="glass-panel neon-glow relative overflow-hidden p-5 sm:p-6">
          ...
          <div className="relative">
            ...
            <p className="mt-1 text-xs text-white/50">
              Wolumen (kg) i liczba powtórzeń z ostatnich{" "}
              {stats.trend.length} treningów.
            </p>
            <div className="mt-5">
