/**
 * WebView aplikacji Android dokleja token do User-Agenta.
 * Rozpoznajemy GymBratAndroidApp oraz starszy AWPAndroidApp (ta sama APK u części użytkowników),
 * żeby pokazać kartę aktualizacji i nie mylić zwykłej przeglądarki / PWA z zainstalowaną aplikacją.
 */
