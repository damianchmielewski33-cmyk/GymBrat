  ...
  return (
    <div className="fixed inset-0 z-[80] flex items-end justify-center bg-black/70 p-0 sm:items-center sm:p-4">
      ...
      <div
        ...
        className="relative z-[1] flex max-h-[92dvh] w-full max-w-lg flex-col overflow-hidden rounded-t-[28px] border border-white/10 bg-[#0c0c0c] sm:rounded-[28px]"
      >
        ...
        <form action={formAction} className="flex min-h-0 flex-1 flex-col overflow-y-auto px-5 pb-6">
          ...
          <div className="mt-6 rounded-2xl border border-white/[0.08] bg-[#141414] px-4 py-4">
            ...
            <div className="mt-3 flex items-center justify-center gap-5">
              <button
                ...
                onClick={() => setMinutes((n) => Math.max(5, n - 5))}
              ...
              <span className="min-w-[4rem] text-center font-display text-4xl tabular-nums text-[var(--gym-gold)]">
                {minutes}
              </span>
              <button
                type="button"
                aria-label="Więcej minut"
                onClick={() => setMinutes((n) => Math.min(300, n + 5))}
                className="inline-flex h-12 w-12 items-center justify-center rounded-full border border-white/15 bg-white/[0.04] text-white"
              >
          ...
          <button
            type="submit"
            disabled={pending}
            className="gold-btn mt-6 inline-flex h-14 w-full items-center justify-center gap-2 rounded-2xl text-base font-semibold disabled:opacity-60"
          >
