  ...
  return (
    ...
    >
      <SheetTrigger
        type="button"
        className={cn(
          "fixed z-[55] flex max-w-[min(calc(100vw-1.5rem),14rem)] items-center gap-2 rounded-2xl border border-[var(--neon)]/45 bg-[linear-gradient(145deg,rgba(var(--neon-rgb),0.42),rgba(var(--neon-rgb),0.16))] px-3.5 py-3 text-left text-xs font-semibold leading-snug text-white shadow-[0_8px_32px_rgba(0,0,0,0.45),0_0_24px_rgba(var(--neon-rgb),0.22)] transition hover:brightness-110 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--neon)]/70 focus-visible:ring-offset-2 focus-visible:ring-offset-[#0a0a0f]",
          "right-3 sm:right-4",
          activeWorkout
