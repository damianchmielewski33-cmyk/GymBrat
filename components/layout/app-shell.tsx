...
import { screenKickerClass } from "@/components/layout/screen";
  ...
  return (
    <div className="relative min-h-screen">
              ...
              >
                ...
                <div className="mt-8 flex flex-col gap-1.5">
                  ...
                  <div className="mt-4 border-t border-white/10 pt-4">
                    <p className={cn(screenKickerClass, "mb-2 px-3")}>
      ...
      >
        {children}
        {!reduceFixedBugs ? (
          <div className="glass-panel mt-10 p-8 md:mt-12">
            <p className={cn(screenKickerClass, "mb-2 text-center")}>
              Siostrzana aplikacja
            </p>
