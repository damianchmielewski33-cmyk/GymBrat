...
export function StartWorkoutFab() {
  ...
  return (
    <Link
      href="/start-workout"
      className={cn(
        "fixed z-[56] inline-flex items-center gap-2 rounded-2xl border border-[var(--mp-teal)]/40",
        "bg-[var(--mp-teal)] px-4 py-3 text-xs font-semibold text-white",
        "shadow-[0_12px_28px_-10px_rgba(0,163,148,0.65)] transition hover:bg-[var(--mp-teal-dark)]",
        "focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--neon)]/70 focus-visible:ring-offset-2 focus-visible:ring-offset-background",
        "left-3 sm:left-4",
        hasActiveSession
