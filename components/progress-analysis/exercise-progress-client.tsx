            ...
            <div className="mt-4 h-[260px] w-full">
              <ResponsiveContainer width="100%" height="100%">
                <LineChart data={points} margin={{ top: 8, right: 8, left: 0, bottom: 0 }}>
                  ...
                  />
                  <Line type="monotone" dataKey="bestE1rm" stroke="#c5a028" strokeWidth={2} dot={{ r: 2.5, fill: "#c5a028", strokeWidth: 0 }} activeDot={{ r: 5, fill: "#c5a028", stroke: "#fff", strokeWidth: 2 }} />
                </LineChart>
              </ResponsiveContainer>
            </div>
          </div>
                ...
                <AreaChart data={points} margin={{ top: 8, right: 8, left: 0, bottom: 0 }}>
                  <defs>
                    <linearGradient id="exTon" x1="0" y1="0" x2="0" y2="1">
                      <stop offset="5%" stopColor="#c5a028" stopOpacity={0.34} />
                  ...
                  <Area type="monotone" dataKey="tonnageKg" stroke="#c5a028" strokeWidth={2} fill="url(#exTon)" dot={{ r: 2.5, fill: "#c5a028", strokeWidth: 0 }} activeDot={{ r: 5, fill: "#c5a028", stroke: "#fff", strokeWidth: 2 }} />
                </AreaChart>
              </ResponsiveContainer>
            </div>
          </div>
